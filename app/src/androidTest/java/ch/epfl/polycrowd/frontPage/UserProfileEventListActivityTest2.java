        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.event_details_title), withText("Date test -.-"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        textView2.check(matches(withText("Date test -.-")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.event_details_description), withText("do not trust this one "),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                3),
                        isDisplayed()));
        textView3.check(matches(withText("do not trust this one ")));

        ViewInteraction textView4 = onView(
                allOf(withId(R.id.organizer_name), withText("nani@haha.com"),
                        childAtPosition(
                                allOf(withId(R.id.organizer_item_parent),
                                        childAtPosition(
                                                withId(R.id.organizers_recycler_view),
                                                0)),
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("nani@haha.com")));
